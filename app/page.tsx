    ...
    <Suspense>
      <div className={`${normalFont.className} text-m max-w-2xl`}>
        ...
        <p className="mb-4">
          ...
          stecken nicht nur riesige Mengen an Daten, in ihnen stecken auch
          unsere eigenen Vorurteile und unsere diskriminierenden Strukturen. Man
          könnte auch sagen: die KI hat die Machtverhältnisse der – westlichen –
          Gesellschaft souverän übernommen, sie hat sie gelernt. Und
          reproduziert sie nun dementsprechend.
        </p>
        <h3 className={`${headingFont.className} text-2xl my-2`}>
        ...
        <p className="mb-4">
          ...
          Abgründe, die «dunklen Ecken» von GPT und Konsorten erkunden können.
          Um den Einstieg ins Testen zu erleichtern, schlagen wir ein paar
          entlarvende Prompts vor, die Sie einfach anklicken können. Probieren
          Sie selber aus, ob Sie damit sexistische oder rassistische Texte und
          Bilder provozieren können. Sie dürfen auch selber kreativ werden!
          Vielleicht kommen Ihnen weitere Szenerien in den Sinn, um dunkle Ecken
          in den Sprach- und Bildmodellen auszuleuchten.
        </p>
        <p className={"my-1"}>
